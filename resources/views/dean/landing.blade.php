        ...
        <div class="container mx-auto px-4 mt-10">
            ...
            <div class="flex justify-center items-center">
                ...
                <div class="w-48 h-48 overflow-hidden rounded-full">
                    <img src="{{ asset('storage/' . $dean->profile) }}" class="w-full h-full object-cover" alt="Profile Picture">
                </div>

                <!-- Staff Information -->
                <div class="ml-4 profile-info">
                    <h3 class="text-xl font-bold mb-2">Dean Profile</h3>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <div class="flex justify-between">
                            ...
                            <span>{{ $dean->religion->name ?? 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
