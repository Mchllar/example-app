    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-6">
                ...
                <input id="password_confirmation" type="password" class="border border-gray-200 rounded p-2 w-full" name="password_confirmation" required autocomplete="new-password">
            </div>

            <div class="mb-6">
                <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Reset Password</button>
            </div>
        </form>
    </x-card>
</x-layout>
