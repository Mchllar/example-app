    ...
    <body class="mb-48">
        ...
        <div class="sidebar" x-data="{ open: false }" :class="{ 'collapsed': !open }">
            ...
            <nav :class="{ 'hidden': !open, 'block': open }">
                <a href="/"><img class="w-38" src="{{ asset('images/School-of-Graduate-Studies-logo.png') }}" alt="Logo"></a>
                ...
                @switch(auth()->user()->role_id)
                    @case(1) {{-- Student --}}
                        ...
                        <li class="font-bold"><a href="{{ route('academic_leave.create') }}">Request for Academic Leave</a></li>
                    ...
                    @case(2) {{-- Supervisor --}}
                        ...
                        <li class="font-bold"><a href="{{route('progress_reports.updateReport')}}">Update Progress Report</a></li>
                    ...
                    @case(3) {{-- Staff --}}
                        ...
                        <li class="font-bold"><a href="{{ route('supervisorStudentAllocation') }}">List of Supervisors</a></li>
                        <li class="font-bold"><a href="{{ route('reviewChangeSupervisorRequests') }}">View Change of Supervisor Requests</a></li>
                        ...
                        <li class="font-bold"><a href="{{ route('reporting-periods.index')}}">Update Reporting Periods</a></li>
                        <li class="font-bold"><a href="{{route('progress_reports.completeReport')}}">Complete Progress Report</a></li>
                        @break
                @endswitch
            @endif
                <li>
